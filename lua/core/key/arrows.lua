...
vim.keymap.set('i', '<Up>', hard_mode_hint('<Up>', '<Esc> then k'), opts)
vim.keymap.set('i', '<Down>', hard_mode_hint('<Down>', '<Esc> then j'), opts)
vim.keymap.set('i', '<Left>', hard_mode_hint('<Left>', '<Esc> then h'), opts)
vim.keymap.set('i', '<Right>', hard_mode_hint('<Right>', '<Esc> then l'), opts)
